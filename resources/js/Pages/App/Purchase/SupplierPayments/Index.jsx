...
export default function SupplierPayments({ auth }) {
  ...
  const fields = useMemo(() => [
    ...
    { name: 'contact_id', label: 'Contact', type: 'fkSelect', col: 10, required: true, fkUrl: api('/api/contacts/'), fkSearchParam: 'search', fkPageSize: 20, fkValueKey: 'id', fkLabelKey: 'name', fkExtraParams: { contact_type: 'supplier', accept_purchase: true } },
    ...
    { name: 'method', label: 'Method', type: 'text', col: 8 },
    ...
    { name: 'tds_charges_account_id', label: 'TDS Charges Account', type: 'fkSelect', col: 8, fkUrl: api('/api/chart-of-accounts/'), fkSearchParam: 'search', fkPageSize: 20, fkValueKey: 'id', fkLabelKey: 'name' },
    {
      ...
      columns: [
        { key: 'purchase_bill_id', name: 'purchase_bill_id', label: 'Purchase Bill', type: 'fkSelect', width: '3fr', fkUrl: api('/api/purchase-bills/'), fkSearchParam: 'search', fkPageSize: 20, fkValueKey: 'id', fkLabelKey: 'name' },
  ...
  const crudInitialValues = {
    ...
    notes: '',
    items: [{ purchase_bill_id: null, allocated_amount: 0 }],
    deleted_item_ids: [],
  };
