...
export default function Dashboard({ metrics = {}, recentTenants = [], planDistribution = [], revenueTrend = [], attention = [], health = [], activity = [] }) {
    ...
    return <CentralLayout title="Command center">
        ...
        <Row gutter={[14,14]}>
            ...
            <Col xs={24} sm={12} xl={6}><MetricCard label="Pending collections" value={formatMoney(metrics.pendingPayments, 'USD', true)} helper={`${metrics.failedPayments || 0} failed payments`} icon={<CreditCardOutlined />} tone={metrics.failedPayments ? 'rose' : 'amber'} /></Col>
        </Row>
