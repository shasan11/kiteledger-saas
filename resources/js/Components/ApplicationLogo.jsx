...
const DEFAULT_LOGO_URL = '/branding/light_logo.png';
...
const fetchApplicationLogo = async (dark = false) => {
    ...
    if (cachedLogoUrls[cacheKey] !== undefined) {
...
export default function ApplicationLogo({
    ...
    const [logoUrl, setLogoUrl] = useState(cachedLogoUrls[cacheKey] ?? null);
    ...
    useEffect(() => {
        ...
        fetchApplicationLogo(dark).then((url) => {
            if (!mounted) return;
            setLogoUrl(url);
        });
