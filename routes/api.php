...
use App\Http\Controllers\Api\SupportTicketCommentController;
...
Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce'])->prefix('custom-domains')->name('api.custom-domains.')->group(function () {
    ...
    Route::post('{domain}/primary', [CustomDomainController::class, 'primary'])->name('primary');
    Route::delete('{domain}', [CustomDomainController::class, 'destroy'])->name('destroy');
});

Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->get('global-search', GlobalSearchController::class)
    ->name('api.global-search');

Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->post('business-rules/validate', BusinessRuleValidationController::class)
    ->name('api.business-rules.validate');

Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->post('utils/send-document-email', [EmailController::class, 'sendDocumentEmail'])
    ->name('api.utils.send-document-email');

Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->prefix('app/context')->name('api.app.context.')->group(function () {
...
Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->prefix('branch-context')->name('api.branch-context.')->group(function () {
...
Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->group(function () {
    ...
    */
    ...
    Route::get('bank-accounts/{bankAccount}/reconciliation', [BankReconciliationController::class, 'summary']);
    Route::get('bank-accounts/{bankAccount}/reconciliation/history', [BankReconciliationController::class, 'history']);
    Route::get('bank-accounts/{bankAccount}/reconciliation/report', [BankReconciliationController::class, 'report']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/auto-match', [BankReconciliationController::class, 'autoMatch']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/manual-match', [BankReconciliationController::class, 'manualMatch']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/unmatch', [BankReconciliationController::class, 'unmatch']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/mark-pending', [BankReconciliationController::class, 'markPending']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/restore', [BankReconciliationController::class, 'restore']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/finalize', [BankReconciliationController::class, 'finalize']);
    Route::post('bank-accounts/{bankAccount}/reconciliation/{reconciliation}/reopen', [BankReconciliationController::class, 'reopen']);
    Route::post('bank-accounts/{bankAccount}/forex-adjustment/preview', [BankReconciliationController::class, 'forexPreview']);
    Route::post('bank-accounts/{bankAccount}/forex-adjustment', [BankReconciliationController::class, 'forexPost']);
    ...
    Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->group(function () {
        ...
        */
        Route::middleware(['web', 'auth'])->prefix('hrm')->group(function () {
            ...
            Route::apiResource('onboarding-checklists', OnboardingChecklistController::class);
        });
        ...
        */
        ...
        Route::middleware(['web', 'auth', 'verified', 'tenant.session', 'tenant.active', 'subscription.valid', 'quota.enforce', 'feature.enforce'])->group(function () {
            Route::get('support-tickets/summary', [SupportTicketController::class, 'summary']);
            Route::patch('support-tickets/{supportTicket}/status', [SupportTicketController::class, 'updateStatus']);
            Route::get('support-tickets/{supportTicket}/comments', [SupportTicketCommentController::class, 'index']);
            Route::post('support-tickets/{supportTicket}/comments', [SupportTicketCommentController::class, 'store']);
            Route::delete('support-tickets/{supportTicket}/comments/{comment}', [SupportTicketCommentController::class, 'destroy']);
