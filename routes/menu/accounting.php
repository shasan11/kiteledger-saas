...
Route::prefix('accounting')->name('accounting.')->group(function () {
    ...
    Route::get('/cash-transfers/add', fn () => Inertia::render('App/Accounting/CashTransfers/Add'))->name('cash-transfers.add');
    Route::get('/cash-transfers/{id}/edit', fn (string $id) => Inertia::render('App/Accounting/CashTransfers/Edit', ['id' => $id]))->name('cash-transfers.edit');
    ...
    Route::get('/journal-vouchers/add', fn () => Inertia::render('App/Accounting/JournalVouchers/Add'))->name('journal-vouchers.add');
    Route::get('/journal-vouchers/{id}/edit', fn (string $id) => Inertia::render('App/Accounting/JournalVouchers/Edit', ['id' => $id]))->name('journal-vouchers.edit');
