import{i as e}from"./rolldown-runtime-aKtaBQYM.js";import{t}from"./axios-BQPRRFHk.js";import{i as n,t as r}from"./index.esm-CtIVDvdE.js";import{r as i,t as a}from"./jsx-runtime-RbF_zoRI.js";import{n as o,t as s}from"./typography-BlWmaYWr.js";import{t as c}from"./select-D1gP4WaH.js";import{t as l}from"./empty-41qDbwiS.js";import{t as u}from"./SearchOutlined-obcpVUK3.js";import{t as ee}from"./PlusOutlined-pba_3Pld.js";import{t as te}from"./dropdown-DjFmDe1J.js";import{t as d}from"./button-B6mwfiyB.js";import{t as f}from"./tabs-D6mM-bRn.js";import{t as p}from"./card-CJAFBOcu.js";import{n as ne,t as m}from"./row-DiFu7gfS.js";import{t as h}from"./space-BXAcXX1Q.js";import{t as g}from"./input-Cwev0fuk.js";import{t as _}from"./EyeOutlined-DWmMawEw.js";import{t as v}from"./message-cpyeTUhV.js";import{t as y}from"./ReloadOutlined-CMtviqc6.js";import{t as b}from"./tag-KfHE2k4Q.js";import{t as re}from"./ReusableCrud-9KVzQslX.js";import{t as ie}from"./DeleteOutlined-CjnT_w1K.js";import{t as ae}from"./EditOutlined-DDNyn6SO.js";import{t as oe}from"./AuthenticatedLayout-HtL-j2sY.js";import{t as x}from"./BankOutlined-DP0-4QOY.js";import{t as se}from"./MoreOutlined-BocTFMVG.js";import{t as S}from"./WalletOutlined-D-eP3Umz.js";import{i as ce}from"./defaultCurrency-CBwoHQOC.js";import{a as C,i as w,n as le,o as ue}from"./index.esm-CBn_TnkU.js";import{r as T}from"./currency-C34x0B2L.js";var E=e(i(),1),D=a(),{Text:O,Title:k}=s,A=``,j=e=>`${A}${e}`,M=()=>{let e=typeof window<`u`?localStorage.getItem(`accessToken`):null;return e?{Authorization:`Bearer ${e}`}:{}},N=(...e)=>{for(let t of e)if(t!=null&&String(t).trim()!==``)return t;return`-`},P=(e={})=>Object.fromEntries(Object.entries(e).filter(([,e])=>e!=null&&e!==``)),F=(e,t={})=>{let n=P(t),r=Object.entries(n).map(([e,t])=>`${encodeURIComponent(e)}=${encodeURIComponent(t)}`).join(`&`);return r?e.includes(`?`)?`${e}&${r}`:`${e}?${r}`:e},I=e=>{if(e==null)return!1;let t=String(e).trim();return t!==``&&t!==`-`},L=(e,t)=>{let n=e?.type===`bank`;return[[`Account Type`,n?`Bank Account`:`Cash Account`],[`Display Name`,e?.display_name],[`Code`,e?.code],[`Currency`,t],...n?[[`Bank Name`,e?.bank_name],[`Account Name`,e?.account_name],[`Account Number`,e?.account_number],[`Bank Account Type`,e?.account_type],[`Swift Code`,e?.swift_code]]:[],[`Description`,e?.description]].filter(([,e])=>I(e)).map(([e,t])=>`${e}: ${t}`).join(`
