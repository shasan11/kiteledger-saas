import{i as e}from"./chunk-62oNxeRG.js";import{i as t}from"./axios-CFfZBleg.js";import{r as n,t as r}from"./jsx-runtime-gigNY91P.js";import{t as i}from"./select-CLz_Fzoi.js";import{t as a}from"./empty-CUdvJnZZ.js";import{t as o}from"./SearchOutlined-CtkD-uP8.js";import{t as s}from"./PlusOutlined-ROE8O2J8.js";import{t as c}from"./dropdown-DP2vvyVC.js";import{t as l}from"./button-B5dvIdG1.js";import{t as u}from"./tabs-Dynodvw3.js";import{t as d}from"./card-FobL5y2W.js";import{n as f,t as p}from"./row-hwYmTzeb.js";import{t as ee}from"./space-Bu5OROsg.js";import{t as te}from"./input-DA-GO2ec.js";import{t as ne}from"./EyeOutlined-DErgsb4d.js";import{n as re,t as m}from"./typography-ofUTwIJF.js";import{t as h}from"./message-Crs4rgLq.js";import{t as g}from"./ReloadOutlined-D48CCI3o.js";import{t as _}from"./tag-BtLgFRxP.js";import{t as v}from"./ReusableCrud-BY7vXs8z.js";import{t as y}from"./DeleteOutlined-BXRr9pOX.js";import{t as ie}from"./EditOutlined-L2h70V4O.js";import{i as b,t as ae}from"./index.esm-BVo_jOMH.js";import{t as oe}from"./AuthenticatedLayout-BwWhhjhw.js";import{t as x}from"./BankOutlined-CJQWdfn6.js";import{t as se}from"./MoreOutlined-wVoq7JyG.js";import{t as S}from"./WalletOutlined-70yEGGV2.js";import{i as ce}from"./defaultCurrency-Dmj1b_8R.js";import{a as C,i as w,n as le,o as T}from"./index.esm-C5mnZMKw.js";import{r as E}from"./currency-CJY3G9oJ.js";var D=e(n(),1),O=r(),{Text:k,Title:A}=m,j=``,M=e=>`${j}${e}`,N=()=>{let e=typeof window<`u`?localStorage.getItem(`accessToken`):null;return e?{Authorization:`Bearer ${e}`}:{}},P=(...e)=>{for(let t of e)if(t!=null&&String(t).trim()!==``)return t;return`-`},F=(e={})=>Object.fromEntries(Object.entries(e).filter(([,e])=>e!=null&&e!==``)),I=(e,t={})=>{let n=F(t),r=Object.entries(n).map(([e,t])=>`${encodeURIComponent(e)}=${encodeURIComponent(t)}`).join(`&`);return r?e.includes(`?`)?`${e}&${r}`:`${e}?${r}`:e},L=e=>{if(e==null)return!1;let t=String(e).trim();return t!==``&&t!==`-`},R=(e,t)=>{let n=e?.type===`bank`;return[[`Account Type`,n?`Bank Account`:`Cash Account`],[`Display Name`,e?.display_name],[`Code`,e?.code],[`Currency`,t],...n?[[`Bank Name`,e?.bank_name],[`Account Name`,e?.account_name],[`Account Number`,e?.account_number],[`Bank Account Type`,e?.account_type],[`Swift Code`,e?.swift_code]]:[],[`Description`,e?.description]].filter(([,e])=>L(e)).map(([e,t])=>`${e}: ${t}`).join(`
