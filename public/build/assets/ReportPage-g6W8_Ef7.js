import{i as e}from"./rolldown-runtime-aKtaBQYM.js";import{t}from"./axios-BQPRRFHk.js";import{o as n,t as r}from"./index.esm-CtIVDvdE.js";import{r as i,t as a}from"./jsx-runtime-RbF_zoRI.js";import{t as o}from"./table-Dr8iJ0aG.js";import{t as s}from"./alert-BMEt18v7.js";import{n as c,t as l}from"./typography-BlWmaYWr.js";import{t as u}from"./skeleton-DlRG_YHH.js";import{t as d}from"./select-D1gP4WaH.js";import{t as f}from"./empty-41qDbwiS.js";import{t as p}from"./tooltip-DRvKpi-S.js";import{t as m}from"./button-B6mwfiyB.js";import{t as h}from"./dayjs.min-BRtZKQ04.js";import{t as g}from"./date-picker-BFeL-0Wn.js";import{t as _}from"./card-C0Xr1RgP.js";import{t as ee}from"./spin-PWSpGrrn.js";import{t as te}from"./checkbox-CSZrqnkw.js";import{n as v,t as y}from"./row-DiFu7gfS.js";import{t as b}from"./divider-vCtgNGuP.js";import{t as x}from"./space-BXAcXX1Q.js";import{t as S}from"./drawer-CW-x5V59.js";import{t as C}from"./list-UNEX1hwg.js";import{t as w}from"./message-cpyeTUhV.js";import{t as ne}from"./ReloadOutlined-CMtviqc6.js";import{t as re}from"./statistic-CWEJLXuk.js";import{t as T}from"./tag-KfHE2k4Q.js";import{t as ie}from"./DownloadOutlined-BHAYoAcO.js";import{l as ae}from"./app-CSoS2LfQ.js";import{t as oe}from"./AuthenticatedLayout-Buz2Bwa0.js";import{t as E}from"./FileSearchOutlined-BEI5E0nt.js";import{t as se}from"./FileExcelOutlined-IeA2wKg_.js";import{t as ce}from"./FilePdfOutlined-CE0QV2KW.js";import{t as le}from"./PlayCircleOutlined-Ddqiyjp1.js";import{t as ue}from"./PrinterOutlined-B7FgpLcl.js";var D=e(i(),1),O=e(h(),1),k=a(),{Text:A}=l;function j({title:e,items:t=[]}){return t.length?(0,k.jsxs)(`div`,{children:[(0,k.jsx)(A,{strong:!0,style:{display:`block`,marginBottom:8},children:e}),(0,k.jsx)(C,{size:`small`,dataSource:t,renderItem:e=>(0,k.jsx)(C.Item,{style:{paddingLeft:0,paddingRight:0},children:(0,k.jsx)(A,{children:e})})})]}):null}var{Paragraph:M,Text:N,Title:P}=l;function de(e,t){return[[t||`Report`,[e.executive_summary]],[`Key Numbers`,e.key_numbers],[`Notable Trends`,e.trends],[`Risks or Anomalies`,e.risks],[`Suggested Actions`,e.recommended_actions],[`Disclaimer`,[e.disclaimer]]].filter(([,e])=>Array.isArray(e)&&e.filter(Boolean).length).map(([e,t])=>`${e}\n${t.filter(Boolean).map(e=>`- ${e}`).join(`
`)}`).join(`
