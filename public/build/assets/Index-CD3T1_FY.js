import{i as e}from"./chunk-62oNxeRG.js";import{i as t}from"./axios-CFfZBleg.js";import{r as n,t as r}from"./jsx-runtime-gigNY91P.js";import{t as i}from"./select-DERalnSy.js";import{t as a}from"./empty-Cy-mvObV.js";import{t as o}from"./SearchOutlined-Crr96xZS.js";import{t as s}from"./PlusOutlined-De-ZOgFQ.js";import{t as c}from"./dropdown-BMdxC7d5.js";import{t as l}from"./button-BmYu5N-C.js";import{t as u}from"./tabs-Wimk-9J6.js";import{t as d}from"./card-DTJPOkHd.js";import{n as f,t as p}from"./row-BBL_6KDH.js";import{t as ee}from"./space-z60N_4CI.js";import{t as te}from"./input-Bo3_yDN1.js";import{t as ne}from"./EyeOutlined-DTqfCdwJ.js";import{n as re,t as m}from"./typography-C64NIvH1.js";import{t as h}from"./message-DCCj7RBS.js";import{t as g}from"./ReloadOutlined-DOxyFpkG.js";import{t as _}from"./tag-6_jbeUxL.js";import{t as v}from"./ReusableCrud-BumAq4_f.js";import{t as y}from"./DeleteOutlined-O1Gcpvax.js";import{t as ie}from"./EditOutlined-CYqjjRyf.js";import{i as b,t as ae}from"./index.esm-DhG8u0u_.js";import{t as oe}from"./AuthenticatedLayout-QCsF94_K.js";import{t as x}from"./BankOutlined-CiTjcRc4.js";import{t as se}from"./MoreOutlined-M1t-PyHU.js";import{t as S}from"./WalletOutlined-Ds9afTGw.js";import{i as ce}from"./defaultCurrency-DdKP97WT.js";import{a as C,i as w,n as le,o as T}from"./index.esm-FDIfAFmq.js";import{r as E}from"./currency-fCvbzOgf.js";var D=e(n(),1),O=r(),{Text:k,Title:A}=m,j=``,M=e=>`${j}${e}`,N=()=>{let e=typeof window<`u`?localStorage.getItem(`accessToken`):null;return e?{Authorization:`Bearer ${e}`}:{}},P=(...e)=>{for(let t of e)if(t!=null&&String(t).trim()!==``)return t;return`-`},F=(e={})=>Object.fromEntries(Object.entries(e).filter(([,e])=>e!=null&&e!==``)),I=(e,t={})=>{let n=F(t),r=Object.entries(n).map(([e,t])=>`${encodeURIComponent(e)}=${encodeURIComponent(t)}`).join(`&`);return r?e.includes(`?`)?`${e}&${r}`:`${e}?${r}`:e},L=e=>{if(e==null)return!1;let t=String(e).trim();return t!==``&&t!==`-`},R=(e,t)=>{let n=e?.type===`bank`;return[[`Account Type`,n?`Bank Account`:`Cash Account`],[`Display Name`,e?.display_name],[`Code`,e?.code],[`Currency`,t],...n?[[`Bank Name`,e?.bank_name],[`Account Name`,e?.account_name],[`Account Number`,e?.account_number],[`Bank Account Type`,e?.account_type],[`Swift Code`,e?.swift_code]]:[],[`Description`,e?.description]].filter(([,e])=>L(e)).map(([e,t])=>`${e}: ${t}`).join(`
