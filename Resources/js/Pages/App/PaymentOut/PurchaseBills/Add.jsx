...
export default function PurchaseBillAdd(props) {
    ...
    const crudInitialValues = useMemo(() => ({
        bill_no: '', bill_date: dayjs(), due_date: null, contact_id: null, warehouse_id: null, currency_id: null, exchange_rate: 1, reference: '', notes: '', items: [{ ...emptyLine }], deleted_item_ids: [],
    }), []);
    ...
    return (
        <AuthenticatedLayout user={props.auth?.user}>
            ...
            <ReusableCrud
                ...
                onAddSuccess={(record) => router.visit(route('payment-out.purchase-bills.show', record.id))}
            />
        </AuthenticatedLayout>
    );
}
