    ...
    <Row style={{ marginTop: 0 }}>
      <Col xs={24}>
        <div className="sales-order-total-card">
          ...
          <div className="sales-order-total-row sales-order-total-grand">
...
const visitSalesOrderShow = (id) => {
  ...
  if (typeof route === 'function') {
    router.visit(route('payment-in.sales-orders.show', id));
    return;
  }
...
export default function SalesOrderAdd(props) {
  const [baseCurrency, setBaseCurrency] = useState(null);
  const [prefillData, setPrefillData] = useState(null);

  useEffect(() => {
    try {
      const stored = sessionStorage.getItem('kiteledger_so_prefill');
      if (stored) {
  ...
  const fields = useMemo(
    () => [
      ...
      {
        name: '_sales_order_totals',
        label: '',
        type: 'custom',
        col: 12,
        render: ({ values }) => <SalesOrderTotals values={values} />,
      },
    ],
    [baseCurrency]
  );
  ...
  return (
    <AuthenticatedLayout auth={props.auth} user={props.auth?.user}>
      ...
      <style>
        {`
          .sales-order-form-drawer .ant-drawer-content {
            background: #ffffff;
          }

          .sales-order-form-drawer .ant-drawer-header {
            min-height: 38px;
            padding: 0 14px;
          ...
          .sales-order-form-drawer .ant-drawer-title {
            font-size: 14px;
            font-weight: 700;
            color: #1f2937;
          }

          .sales-order-form-drawer .ant-drawer-body {
            padding: 12px 14px 24px;
            background: #ffffff;
          }

          .sales-order-form-drawer .ant-form {
            max-width: 100%;
            margin: 0;
            padding: 0;
          }

          .sales-order-form-drawer .ant-form-item {
            margin-bottom: 12px;
          }

          .sales-order-form-drawer .ant-form-item-label {
            padding-bottom: 3px;
          }

          .sales-order-form-drawer .ant-form-item-label > label {
            height: auto;
            font-size: 12px;
            font-weight: 600;
            color: #1f2937;
          ...
          .sales-order-form-drawer .ant-input,
          .sales-order-form-drawer .ant-input-number,
          .sales-order-form-drawer .ant-picker,
          .sales-order-form-drawer .ant-select-selector {
            min-height: 31px;
          ...
          .sales-order-form-drawer textarea.ant-input {
            min-height: 76px;
            resize: vertical;
          }

          .sales-order-form-drawer .ant-input[disabled],
          .sales-order-form-drawer .ant-input-number-disabled,
          .sales-order-form-drawer .ant-select-disabled .ant-select-selector {
            color: #111827;
            background: #eef2f7 !important;
          }

          .sales-order-form-drawer .ant-form-item-explain,
          .sales-order-form-drawer .ant-form-item-extra {
            font-size: 11px;
          }

          .sales-order-form-drawer .ant-btn-primary {
            min-width: 88px;
            height: 31px;
            border-radius: 0;
            background: #16a34a;
          ...
          .sales-order-form-drawer .ant-btn-primary:hover {
            background: #15803d !important;
            border-color: #15803d !important;
          }

          .sales-order-form-drawer .ant-btn {
            border-radius: 0;
          }

          .sales-order-form-drawer .ant-table-wrapper,
          .sales-order-form-drawer [class*="objectArray"],
          .sales-order-form-drawer [class*="ObjectArray"] {
            margin-top: 8px;
          }

          .sales-order-form-drawer .ant-table {
            border: 1px solid #cbd5e1;
            border-radius: 0;
          }

          .sales-order-form-drawer .ant-table-thead > tr > th {
          ...
          .sales-order-form-drawer .ant-table-tbody > tr > td {
            padding: 7px 10px;
            vertical-align: top;
          }

          .sales-order-form-drawer .ant-table-tbody .ant-form-item {
            margin-bottom: 0;
          }

          .sales-order-total-card {
          ...
          .sales-order-total-row strong {
            font-weight: 600;
          }

          .sales-order-total-grand {
            margin-top: 8px;
            padding-top: 14px;
            padding-bottom: 14px;
          ...
          .sales-order-total-grand strong {
            font-size: 18px;
          }
      ...
      <ReusableCrud
        key={baseCurrency?.id || 'sales-order-add'}
        title="Sales Orders"
        addTitle="New Sales Order"
