...
const emptyAllocation = { id: undefined, invoice_id: null, allocated_amount: 0 };
...
export default function PaymentAdd(props) {
    const fields = useMemo(() => [
        ...
        {
            name: 'items', label: 'Invoice Allocations', type: 'objectArray', col: 24, addButtonLabel: 'Add Invoice', defaultItem: { ...emptyAllocation }, headerBg: '#4b5563', headerColor: '#ffffff',
            columns: [
    ...
    const crudInitialValues = useMemo(() => ({
        payment_no: '', payment_date: dayjs(), contact_id: null, account_id: null, currency_id: null, amount: 0, payment_method: null, bank_charges_account_id: null, bank_charges: 0, tds_charges_account_id: null, tds_charges: 0, reference: '', notes: '', items: [], deleted_item_ids: [],
    }), []);
    ...
    return (
        <AuthenticatedLayout user={props.auth?.user}>
            ...
            <ReusableCrud
                ...
                onAddSuccess={(record) => router.visit(route('payment-in.payments.show', record.id))}
            />
        </AuthenticatedLayout>
    );
}
