  ...
  const fields = useMemo(() => [
    {
      ...
      quickAdd: {
        ...
        initialValues: { contact_type: 'customer', type: 'customer', name: '', phone: '', email: '', address: '', active: true },
        ...
        transformPayload: (v) => ({ ...v, contact_type: v.contact_type || 'customer', type: v.type || 'customer', active: true }),
      },
    },
