...
export default function InvoiceEdit({ id, ...props }) {
    const fields = useMemo(() => [
        ...
        { name: 'due_date', label: 'Due Date', type: 'datePicker', col: 8, format: 'DD-MM-YYYY' },
        {
            ...
            placeholder: 'Select Warehouse', fkUrl: api('/api/warehouses/'), fkSearchParam: 'search', fkPageSize: 20, fkValueKey: 'id', fkLabelKey: 'name',
            allowClear: true,
            disabled: (values) => !!(values?.approved),
            help: 'Selecting a warehouse will deduct stock from this warehouse when the invoice is approved. Cannot be changed after approval.',
        },
        ...
        { name: 'reference', label: 'Reference', type: 'text', col: 8, placeholder: 'Reference' },
        {
            ...
            columns: [
                ...
                { key: 'discount_percent', name: 'discount_percent', label: 'Disc%', type: 'number', width: '10%', min: 0, max: 100 },
                ...
                { key: 'tax_amount', name: 'tax_amount', label: 'Tax Amt', type: 'number', width: '12%', min: 0, disabled: true, formula: (row) => calculateLine(row).tax_amount },
