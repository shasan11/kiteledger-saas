...
export default function InvoiceAdd(props) {
    ...
    const crudInitialValues = useMemo(() => ({
        invoice_no: '', invoice_date: dayjs(), due_date: null, contact_id: null, warehouse_id: null, credit_term_id: null, currency_id: null, exchange_rate: 1, reference: '', notes: '', items: [{ ...emptyLine }], deleted_item_ids: [],
    }), []);
    ...
    return (
        <AuthenticatedLayout user={props.auth?.user}>
            ...
            <ReusableCrud
                ...
                onAddSuccess={(record) => router.visit(route('payment-in.invoices.show', record.id))}
            />
        </AuthenticatedLayout>
    );
}
