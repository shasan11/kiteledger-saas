...
export default function WarehouseTransferAdd(props) {
    ...
    const crudInitialValues = useMemo(() => ({
        transfer_no: '', transfer_date: dayjs(), from_warehouse_id: null, to_warehouse_id: null, notes: '', items: [{ product_id: null, qty: 1, remarks: '' }], deleted_item_ids: [],
    }), []);
    ...
    return (
        <AuthenticatedLayout user={props.auth?.user}>
            ...
            <ReusableCrud
                ...
                addTitle="New Warehouse Transfer"
                ...
                onAddSuccess={(record) => router.visit(route('inventory.warehouse-transfers.show', record.id))}
            />
        </AuthenticatedLayout>
    );
}
