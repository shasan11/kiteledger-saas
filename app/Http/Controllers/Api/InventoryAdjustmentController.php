...
class InventoryAdjustmentController extends BaseCrudApiController
{
    ...
    protected array $relations = ['branch','warehouse', 'userAdd', 'approvedBy'];
    ...
    protected array $storeRules = ['branch_id'=>['nullable','uuid','exists:branches,id'],'adjustment_no'=>['nullable','string','max:40','unique:inventory_adjustments,adjustment_no'],'adjustment_date'=>['required','date'],'warehouse_id'=>['required','uuid','exists:warehouses,id'],'reason'=>['nullable','string','max:150'],'notes'=>['nullable','string'],'remarks'=>['nullable','string'],'status'=>['nullable','in:draft,posted,cancelled']];
    protected function updateRules(Request $request, Model $record): array { return ['branch_id'=>['sometimes','nullable','uuid','exists:branches,id'],'adjustment_no'=>['sometimes','required','string','max:40','unique:inventory_adjustments,adjustment_no,'.$record->id.',id'],'adjustment_date'=>['sometimes','required','date'],'warehouse_id'=>['sometimes','required','uuid','exists:warehouses,id'],'reason'=>['sometimes','nullable','string','max:150'],'notes'=>['sometimes','nullable','string'],'remarks'=>['sometimes','nullable','string'],'status'=>['sometimes','nullable','in:draft,posted,cancelled']]; }
