...
class DebitNoteController extends BaseCrudApiController
{
    ...
    protected array $nested = [
        'items' => [
            'relation' => 'debitNoteLines',
            'model' => DebitNoteLine::class,
            'foreign_key' => 'debit_note_id',
    ...
    protected array $storeRules = [
        ...
        'debit_note_no' => ['nullable', 'string', 'max:40', 'unique:debit_notes,debit_note_no'],
    ...
    {
        $total = (float) $record->debitNoteLines()->sum('line_total');
