...
class QuotationController extends BaseCrudApiController
{
    ...
    protected array $nested = ['items'=>['relation'=>'quotationLines','model'=>QuotationLine::class,'foreign_key'=>'quotation_id','delete_key'=>'deleted_item_ids','required'=>true,'min'=>1,'replace_on_update'=>false,'relations'=>['productVariant','taxRate'],'relation_details'=>['productVariant'=>'product_variant_id','taxRate'=>'tax_rate_id'],'rules'=>['product_variant_id'=>['nullable','uuid','exists:product_variants,id'],'product_name'=>['nullable','string','max:180'],'description'=>['nullable','string','max:200'],'qty'=>['required','numeric','min:0'],'unit_price'=>['required','numeric','min:0'],'discount_percent'=>['nullable','numeric','min:0'],'tax_rate_id'=>['nullable','uuid','exists:tax_rates,id'],'tax_amount'=>['nullable','numeric','min:0'],'line_total'=>['nullable','numeric','min:0']],'update_rules'=>['product_variant_id'=>['nullable','uuid','exists:product_variants,id'],'product_name'=>['nullable','string','max:180'],'description'=>['nullable','string','max:200'],'qty'=>['required','numeric','min:0'],'unit_price'=>['required','numeric','min:0'],'discount_percent'=>['nullable','numeric','min:0'],'tax_rate_id'=>['nullable','uuid','exists:tax_rates,id'],'tax_amount'=>['nullable','numeric','min:0'],'line_total'=>['nullable','numeric','min:0']]]];
    protected array $storeRules = ['branch_id'=>['nullable','uuid','exists:branches,id'],'contact_id'=>['required','uuid','exists:contacts,id'],'quotation_no'=>['nullable','string','max:40','unique:quotations,quotation_no'],'quotation_date'=>['required','date'],'expiry_date'=>['nullable','date'],'credit_term_id'=>['nullable','uuid','exists:credit_terms,id'],'currency_id'=>['nullable','uuid','exists:currencies,id'],'notes'=>['nullable','string'],'status'=>['nullable','in:draft,sent,accepted,rejected,expired,cancelled']];
    protected function updateRules(Request $request, Model $record): array { return ['branch_id'=>['sometimes','nullable','uuid','exists:branches,id'],'contact_id'=>['sometimes','required','uuid','exists:contacts,id'],'quotation_no'=>['sometimes','nullable','string','max:40','unique:quotations,quotation_no,'.$record->id.',id'],'quotation_date'=>['sometimes','required','date'],'expiry_date'=>['sometimes','nullable','date'],'credit_term_id'=>['sometimes','nullable','uuid','exists:credit_terms,id'],'currency_id'=>['sometimes','nullable','uuid','exists:currencies,id'],'notes'=>['sometimes','nullable','string'],'status'=>['sometimes','nullable','in:draft,sent,accepted,rejected,expired,cancelled']]; }
