...
class LeadController extends BaseCrudApiController
{
    ...
    protected array $dateRangeFilters = [
        'next_follow_up_date' => ['from' => 'follow_up_from', 'to' => 'follow_up_to'],
        'created_at' => ['from' => 'date_from', 'to' => 'date_to'],
    ];
    ...
    protected array $storeRules = [
        'lead_no' => ['nullable', 'string', 'max:40', 'unique:leads,lead_no'],
    ...
    {
        return [
            'lead_no' => ['sometimes', 'nullable', 'string', 'max:40', 'unique:leads,lead_no,' . $record->id . ',id'],
