...
This command runs `migrate:fresh`, seeds only `DatabaseSeeder`, and destroys the
configured database contents. Never point it at customer data. Do not place a
SQLite or PostgreSQL dump at this path.
