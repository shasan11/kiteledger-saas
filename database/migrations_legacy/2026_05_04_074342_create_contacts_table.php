...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('contacts', function (Blueprint $table) {
            ...
            $table->enum('tax_registration_type', ["pan","vat","gstin","tan","ein","sales_tax_permit","state_tax_id","none"])->default('none');
            ...
            $table->decimal('credit_limit', 16, 2)->default(0)->nullable();
