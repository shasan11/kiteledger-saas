...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('employee_reimbursements', function (Blueprint $table): void {
            ...
            $table->decimal('base_currency_amount', 20, 6)->default('0');
            $table->text('description')->nullable();
        ...
        Schema::create('payroll_payments', function (Blueprint $table): void {
            ...
            $table->uuid('currency_id')->nullable();
            $table->decimal('exchange_rate', 16, 6)->default('1');
            $table->decimal('base_currency_amount', 20, 6);
        ...
        Schema::create('payroll_settings', function (Blueprint $table): void {
            ...
            $table->decimal('late_deduction_per_day', 20, 6)->default('0');
        ...
        Schema::create('payrolls', function (Blueprint $table): void {
            ...
            $table->decimal('total_net_payable', 20, 6)->default('0');
            $table->uuid('currency_id')->nullable();
            $table->decimal('exchange_rate', 18, 4)->default('1');
            ...
            $table->decimal('total_earnings', 20, 6)->default('0');
            $table->decimal('total_base_currency_amount', 20, 6)->default('0');
        ...
        Schema::create('payslips', function (Blueprint $table): void {
            ...
            $table->decimal('hourly_salary', 20, 6)->default('0');
            $table->decimal('working_hour', 8, 2)->default('0');
            $table->decimal('salary_payable', 20, 6)->default('0');
            ...
            $table->decimal('total_payable', 20, 6)->default('0');
            ...
            $table->string('status')->default('draft');
            $table->decimal('gross_earnings', 20, 6)->default('0');
            $table->decimal('total_deductions', 20, 6)->default('0');
            $table->decimal('employer_contributions', 20, 6)->default('0');
            $table->decimal('net_payable', 20, 6)->default('0');
            $table->uuid('currency_id')->nullable();
            $table->decimal('exchange_rate', 16, 6)->default('1');
            $table->decimal('base_currency_amount', 20, 6)->default('0');
            $table->decimal('payable_days', 8, 2)->default('0');
