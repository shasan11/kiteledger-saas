...
class CentralRolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            'content_manager' => ['Content Manager', ['dashboard.view', 'cms.view', 'cms.manage', 'cms.publish', 'media.manage', 'lead.view', 'lead.manage', 'blog.view', 'blog.manage', 'seo.manage', 'website.branding.manage']],
