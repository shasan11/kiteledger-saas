...
class PlatformSettingsSeeder extends Seeder
{
        ...
        foreach ($this->groups() as $group => $labels) {
            foreach (array_values($labels) as $order => $definition) {
                ...
                $setting->fill([
                    ...
                    'is_encrypted' => (bool) $encrypted, 'is_public' => in_array($group, ['general', 'branding', 'company', 'support', 'privacy', 'seo', 'website', 'design'], true) && ! $encrypted,
    ...
    private function groups(): array
    {
        return [
            ...
            'design' => [
                ['Design preset', 'select', 'kiteledger-default'],
                ['Typography scale', 'select', 'standard'],
                ['Layout density', 'select', 'standard'],
                ['Corner style', 'select', 'soft'],
                ['Card style', 'select', 'bordered'],
                ['Button style', 'select', 'soft'],
                ['Heading font', 'text', 'Manrope'],
                ['Body font', 'text', 'Manrope'],
                ['Primary color', 'color', '#176b5b'],
                ['Secondary color', 'color', '#10211d'],
                ['Accent color', 'color', '#d97706'],
                ['Background color', 'color', '#fbfcfb'],
                ['Surface color', 'color', '#f2f6f4'],
                ['Heading color', 'color', '#14231f'],
                ['Text color', 'color', '#3d4d48'],
                ['Muted color', 'color', '#687772'],
                ['Border color', 'color', '#dce4e1'],
                ['Footer background', 'color', '#10211d'],
            ],
            ...
            'ai' => [
                ...
                ['AI Copilot V2 enabled', 'switch', false],
                ...
                ['AI document scanning enabled', 'switch', true],
                ['AI document provider', 'select', ''],
                ['AI document model', 'text', ''],
    ...
    private function optionsFor(string $group, string $label, string $input): ?array
    {
        ...
        return match ($group.'.'.$label) {
            ...
            'ai.AI document provider' => [
                ['value' => '', 'label' => 'Use primary AI provider'],
                ['value' => 'openai', 'label' => 'OpenAI'],
                ['value' => 'gemini', 'label' => 'Gemini'],
                ['value' => 'openrouter', 'label' => 'OpenRouter'],
                ['value' => 'groq', 'label' => 'Groq (images and DOCX only)'],
            ],
            ...
            'design.Design preset' => ['kiteledger-default', 'minimal', 'corporate', 'fintech', 'dark'],
            'design.Typography scale' => ['compact', 'standard', 'large'],
            'design.Layout density' => ['compact', 'standard', 'spacious'],
            'design.Corner style' => ['square', 'soft', 'rounded'],
            'design.Card style' => ['flat', 'bordered', 'soft-shadow', 'elevated'],
            'design.Button style' => ['square', 'soft', 'rounded', 'pill'],
            default => null,
        };
    }
}
