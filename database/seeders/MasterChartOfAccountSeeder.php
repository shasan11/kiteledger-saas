...
class MasterChartOfAccountSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $accounts = [
            ...
            ['code' => '4320', 'name' => 'Inventory Adjustment Gain', 'type' => 'income', 'parent_code' => '4300'],
            ...
            ['code' => '5110', 'name' => 'Cost of Goods Sold', 'type' => 'expense', 'parent_code' => '5000'],
            ...
            ['code' => '5320', 'name' => 'Interest Expense', 'type' => 'expense', 'parent_code' => '5300'],
            ['code' => '5330', 'name' => 'Inventory Adjustment Loss', 'type' => 'expense', 'parent_code' => '5300'],
